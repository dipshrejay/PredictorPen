    ...
    def run(self):
        while True:
            ...
            if letter == "+":
                ...
                text_area.insert(INSERT,"Shreyas Sign Matched ")
            elif letter == "#":
                text_area.insert(INSERT,"Diptesh Sign Matched ")
            elif letter == "%":
                text_area.insert(INSERT,"Vijay Sign Matched ")
            else:
                text_area.insert(INSERT,letter)

def activate():
    '''
    Use for activating the canvas
    :return: None
    '''
...
def deactivate():
    '''
    Use for deactivating the canvas
    :return: None
    '''
...
start = Button(master, text="Activate", command=activate)
start.grid(row=1, column=3)
stop = Button(master, text="Deactivate", command=deactivate)
